  ...
  return (
    <div className="min-h-screen bg-brand-cream flex font-sans text-stone-600 selection:bg-brand-red/20">
      ...
      <aside className="hidden md:flex flex-col w-20 lg:w-64 bg-white fixed h-full z-20 border-r border-stone-100/80 transition-all duration-300 shadow-[2px_0_24px_-12px_rgba(0,0,0,0.05)]">
        <div className="h-28 flex items-center justify-center pt-4">
          <div className="hidden lg:block px-6">
            {/* Imagem da Logo para manter consistência com Login */}
            <img src={logoUrl} alt="Pintando 7" className="w-full h-auto object-contain max-h-20" />
          </div>
          <div className="lg:hidden">
             <img src={logoUrl} alt="P7" className="w-10 h-auto object-contain" />
          </div>
        </div>
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center space-x-3 px-3 py-3 rounded-2xl transition-all duration-300 group font-bold relative ${
                  isActive
        ...
        <div className="p-4 mt-auto">
          ...
          <div className="bg-stone-50 p-2.5 rounded-2xl flex items-center gap-3 transition-all hover:bg-stone-100 cursor-pointer group border border-stone-100">
            <div className="w-8 h-8 rounded-full bg-white text-brand-red flex items-center justify-center font-black shadow-sm text-xs border border-stone-100">
            ...
            <div className="overflow-hidden flex-1 hidden lg:block">
              ...
              <p className="text-[9px] text-stone-400 font-bold uppercase tracking-wide">Admin</p>
            </div>
      ...
      {/* Mobile Header */}
      <div className="md:hidden fixed top-0 w-full bg-white/80 backdrop-blur-md z-30 px-6 py-3 flex items-center justify-between border-b border-stone-100">
      ...
      {/* Main Content Area */}
      <main className="flex-1 md:ml-20 lg:ml-64 p-4 lg:p-8 pt-24 md:pt-8 overflow-x-hidden relative">
